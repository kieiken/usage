...
if __name__ == "__main__":
    ...
    OPTIONS = {
        ...
        "resources": [
            ...
            "i18n.json",
            "usage_statusline.py",
            "scripts/usage-claude-desktop-deriver.py",
            "scripts/install-desktop-deriver.sh",
            "scripts/uninstall-desktop-deriver.sh",
        ],
        "includes": [
            "AppKit",
            "Foundation",
        ...
        "plist": {
            ...
            "NSHumanReadableCopyright": (
                "Copyright (c) 2026 lollapalooza. "
                "Modified Claude Desktop adaptation, AGPL-3.0-only."
            ),
        },
    }
